...
END AS "Most_Effective_Ad",
	...
	SUM(CASE WHEN a."Bulkmail_ad" THEN 1 ELSE 0 END)+SUM(CASE WHEN a."Twitter_ad" THEN 1 ELSE 0 END)+
	SUM(CASE WHEN a."Instagram_ad" THEN 1 ELSE 0 END)+SUM(CASE WHEN a."Facebook_ad" THEN 1 ELSE 0 END)+
	SUM(CASE WHEN a."Brochure_ad" THEN 1 ELSE 0 END) AS "Total_Successful_Conversion",
...
GROUP BY 
    m."Country"
ORDER BY 
	"Total_Successful_Conversion" DESC;	
